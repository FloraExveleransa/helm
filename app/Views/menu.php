    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
         <div class="navbar-brand">
           <a class="navbar-brand brand-logo" href="schedules">
             <div class="sidebar-header">
                  <img src="<?php echo base_url('images/sph.jpg') ?>" alt="logo">
...
<li class="nav-item nav-profile dropdown">
    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
        <img src="<?php echo base_url('images/sph.jpg') ?>" alt="User Profile">
    </a>
    ...
    <span class="menu-title">History</span>
           ...
           <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="activity"> Aksi Login</a></li>
              </ul>
            </div>
          </li>
